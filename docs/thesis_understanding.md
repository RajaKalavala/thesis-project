...
- Two parallel files in the upstream distribution: 5-option (A–E, canonical) and 4-option (A–D, with `metamap_phrases` attached). **Use the 4-option variant** for all experiments — see [`dataset.md`](dataset.md) for the field-level reference.
