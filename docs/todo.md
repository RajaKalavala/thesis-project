...
- [ ] Metrics: Exact Match Accuracy filled (above). Answer Correctness + Hallucination Rate (Faithfulness < 0.5) **pending** — require `src/eval/ragas_eval.py` (next session — wraps RAGAS with Claude 3.5 Sonnet judge against `golden_234/predictions.jsonl`)
